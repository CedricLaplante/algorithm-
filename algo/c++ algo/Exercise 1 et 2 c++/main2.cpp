...
{	
	...
	std::cout << "la somme est: " << (note1 + note2) << std::endl;
	std::cout << "soustraction des deux nombre" << (note1 - note2) << std::endl;
	std::cout << "la division" << (note1 / note2) << std::endl;
	std::cout << "la mutiplication" << (note1 * note2) << std::endl;
	std::cout << "le modulo" << (note1 % note2) << std::endl;
